...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.jwtauth' => 'getApp_JwtauthService',
            'app.transform_text' => 'getApp_TransformTextService',
            ...
            'security.user.provider.concrete.proveedor' => 'getSecurity_User_Provider_Concrete_ProveedorService',
    ...
    /**
     * Gets the public '_defaults' shared autowired service.
     *
     * @throws RuntimeException always since this service is expected to be injected dynamically
     */
    protected function getDefaultsService()
    {
        throw new RuntimeException('You have requested a synthetic service ("_defaults"). The DIC does not know how to construct this service.');
    }
    ...
    /**
     * Gets the public 'app.helpers' shared service.
     *
     * @return \AppBundle\Services\Helpers
     */
    protected function getApp_HelpersService()
    {
        return $this->services['app.helpers'] = new \AppBundle\Services\Helpers();
    }

    /**
     * Gets the public 'app.jwtauth' shared service.
     *
     * @return \AppBundle\Services\JwtAuth
     */
    protected function getApp_JwtauthService()
    {
        return $this->services['app.jwtauth'] = new \AppBundle\Services\JwtAuth($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'app.transform_text' shared service.
     *
     * @return \AppBundle\Services\TextPostTranf
     */
    protected function getApp_TransformTextService()
    {
        return $this->services['app.transform_text'] = new \AppBundle\Services\TextPostTranf();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lIDE6YOErG', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ub7+HKybRB', 0, '5ufLdUs0jaGS1WlJ2fsks7', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'blog_personal', 'user' => 'root', 'password' => 'pagos123', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e9e828eeb6796e3dd10a629f18a04ceccd322c74b633617977938cf741a08714');
    ...
    {
        $this->services['fos\restbundle\view\viewhandlerinterface'] = $instance = new \FOS\RestBundle\View\ViewHandler($this->get('router'), $this->get('fos_rest.serializer'), $this->get('templating', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('request_stack'), array('json' => false, 'html' => true), 400, 204, false, array('html' => 302), 'twig');
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'html'), 'fallback_format' => 'html', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        return $this->services['kilik_table'] = new \Kilik\TableBundle\Services\TableService($this->get('twig'), $this->get('form.factory'));
    }
    ...
    {
        return $this->services['kilik_table_api'] = new \Kilik\TableBundle\Services\TableApiService($this->get('twig'), $this->get('form.factory'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\Users' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 4))));
    }
    ...
    {
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(), 1 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 2 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 3 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(), 4 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 5 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(new \Symfony\Component\Serializer\Mapping\Factory\ClassMetadataFactory(new \Symfony\Component\Serializer\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')))), NULL), NULL, $this->get('property_accessor'), NULL)), array(0 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\JsonEncoder()));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8e1900bdff823c7161655268d6e46395d2890525');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s4rNmS0QRX', 0, '5ufLdUs0jaGS1WlJ2fsks7', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+HTNnl0cBQ', 0, '5ufLdUs0jaGS1WlJ2fsks7', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.proveedor']) ? $this->services['security.user.provider.concrete.proveedor'] : $this->getSecurity_User_Provider_Concrete_ProveedorService()) && false ?: '_'}, new \Symfony\Component\Security\Core\User\UserChecker(), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5e8dca3acd05b5.36478459')), true);
    ...
    {
        return $this->services['security.user.provider.concrete.proveedor'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle\\Entity\\Users', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'blog_personal',
            'database_user' => 'root',
            'database_password' => 'pagos123',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '8e1900bdff823c7161655268d6e46395d2890525',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '8e1900bdff823c7161655268d6e46395d2890525',
