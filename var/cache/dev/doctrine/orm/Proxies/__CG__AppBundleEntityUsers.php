...
class Users extends \AppBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'surname', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'nick', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'create_at', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'active', '' . "\0" . 'AppBundle\\Entity\\Users' . "\0" . 'administrator'];
        }
    ...
    public function setCreate_at($create_at)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCreate_at', [$create_at]);
    ...
    public function getCreate_at()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCreate_at', []);
